<?php
/**
 * Contains \mishanki\PhpEws\Request\FindMailboxStatisticsByKeywordsType.
 */
...
class FindMailboxStatisticsByKeywordsType extends BaseRequestType
{
     ...
     * @since Exchange 2013
     *
     * @var \mishanki\PhpEws\ArrayType\ArrayOfUserMailboxesType
     */
    public $Mailboxes;
     ...
     * @since Exchange 2013
     *
     * @var \mishanki\PhpEws\ArrayType\ArrayOfSearchItemKindsType
     */
    public $MessageTypes;
