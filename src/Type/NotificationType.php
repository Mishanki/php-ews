...
class NotificationType extends Type
{
     ...
     * @since Exchange 2007
     *
     * @var \mishanki\PhpEws\Type\MovedCopiedEventType
     */
    public $CopiedEvent;
     ...
     * @since Exchange 2007
     *
     * @var \mishanki\PhpEws\Type\BaseObjectChangedEventType
     */
    public $CreatedEvent;
     ...
     * @since Exchange 2007
     *
     * @var \mishanki\PhpEws\Type\ModifiedEventType
     */
     ...
     * @since Exchange 2007
     *
     * @var \mishanki\PhpEws\Type\BaseNotificationEventType
     */
    public $StatusEvent;
